...
- Seis páginas cerradas: inicio con buscador, listado con filtros, ficha de inmueble, contacto, "Vende tu casa" con formulario de valoración y "Sobre nosotros" con los 55 años de historia.
- Diseño propio sobre su marca renovada de 2026 (la roseta, el gallo y los violetas), aplicado a logotipo, colores y tipografía.
- Hasta 30 inmuebles en el lanzamiento, con fotos optimizadas. El prototipo ya muestra ocho inmuebles reales, como el ático dúplex del Centro o el pareado de Monachil.
- Formularios de contacto y de valoración con avisos claros, y botón de WhatsApp.
- Aviso legal, política de privacidad y de cookies con los datos reales de la empresa, página 404 amable y favicon.
- Títulos y descripciones propios por página para aparecer mejor en Google.
- Alta guiada en Google Business Profile y despliegue en su dominio actual.
- Medición de velocidad de la web actual y de la nueva, entregada por escrito.

### Qué NO incluye (fase 2, presupuesto aparte)

- Sincronización automática con Inmovilla, Idealista o Fotocasa.
- Gestor de contenidos para que usted edite solo.
- Fotografía profesional de los inmuebles.
- Textos por barrio más allá de las seis páginas.
...
- Semana 1: diseño sobre la marca nueva y revisión del prototipo con usted.
- Semana 2: construcción de las seis páginas con su contenido real.
- Semana 3: textos legales, formularios y pruebas en móvil y ordenador.
- Semana 4: despliegue en su dominio, alta guiada en Google y medición de velocidad.
...
- Alojamiento del sitio (hosting) y dominio, con su renovación anual.
- Altas y bajas de inmuebles, hasta 10 movimientos al mes, en un plazo de 48 horas laborables.
...
- El logotipo original en vectorial: la marca de 2026 solo existe como fotografía de la tarjeta impresa, y su web sigue con el logotipo antiguo.
- Los datos fiscales de la empresa (nombre registrado y CIF) para el aviso legal.
- La historia de la empresa para contar bien esos 55 años.
- El acceso al dominio para publicar la web nueva en su dirección actual.

## 7. Próximo paso

Le propongo ver juntos el prototipo que acompaña a este informe, para que toque el diseño con sus propios inmuebles. Si le convence, me entrega los materiales y en cuatro semanas su web nueva estará publicada por 1.200 euros más IVA.
